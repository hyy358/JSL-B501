...
{
	ClearBuf(RX1_Buffer,COM_RX1_Lenth);
	COM1.B_RX_OK = 0;
	COM1.RX_Cnt = 0;
}
#endif
...
//	}
//}
void Uart3SendBuf(u8 *buf,u8 len)
{
    while(len--)
		TX3_write2buff(*buf++);
}
...
//			if((COM3.RX_Cnt > 3) && (RX3_Buffer[COM3.RX_Cnt-1] == 0x0A) && (RX3_Buffer[COM3.RX_Cnt-2] == 0x0D) && (RX3_Buffer[1] != 'T') && (RX3_Buffer[0] != 'A'))
//			{
//				COM3.B_RX_OK = 1;
//			}
		}
...
{
	ClearBuf(RX3_Buffer,COM_RX3_Lenth);
	COM3.B_RX_OK = 0;
	COM3.RX_Cnt = 0;
}
